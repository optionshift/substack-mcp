...
def get_navigator() -> dict:
    return {
        ...
        "api_quirks": [
            ...
            "Auth uses session cookies (substack.sid / connect.sid), not API keys.",
            "Notes endpoint is /api/v1/notes (NOT /reader/notes/feed).",
            "User profile endpoint is /api/v1/user/profile/self (NOT /user/me).",
