TOOLS = [
    ...
    {"name": "ss_create_draft", "description": "Create an article draft. Voice-checked. body_markdown is plain paragraphs only — no rich markdown conversion. Params: title, body_markdown, subtitle (optional), force."},
    {"name": "ss_update_draft", "description": "Update fields on an existing article draft. Voice-checked when string fields change. body_markdown is plain paragraphs only. Params: draft_id, fields, force."},
